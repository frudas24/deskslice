...
* [x] Modo `Presetup (Fullscreen)`:
  ...
  * [x] UI permite trazar:
    ...
    * [x] Ajustar rectángulos existentes (drag/resize + nudge) sin re-trazar desde cero.
...
* [x] “No magia”: sin auto-validación; tú calibras manualmente y listo.
* [x] Windows 11.
* [x] Layout por dominios: `./cmd` cableado, `./internal` lógica.
* [x] CI/CD: GitHub Actions (build + scanners) y releases con tags `v*`.
...
### Mejoras UX / Diseño (post-MVP)

* [x] Default video mode: MJPEG (más robusto) + WebRTC opcional.
* [x] Fullscreen mode con drawers laterales (Menu/Chat), autohide de controles y safe-area insets.
* [x] Botones H+/H-/V+/V- + Reset para ajustar escala en fullscreen (persistido en el navegador).
* [x] Botón “mouse lock” en fullscreen para bloquear input y permitir gestos nativos del móvil (zoom/pan).
  * (Implementado como pinch-zoom + pan local cuando el mouse está bloqueado.)
* [x] Scroll overlay tipo joystick (todas las direcciones) activable con botón en fullscreen.
* [x] Debug overlays (rects de calib) activable desde menú lateral.
* [x] Resume/reconnect (sleep/wake): refrescar MJPEG + reconectar WS cuando el browser vuelve.
* [x] Post FX sliders (Clarity/Denoise) en el menú (0 = desactivado).
* [x] Presets de performance que aplican MJPEG interval/quality en runtime (sin editar `.env`).
* [x] Reset runtime: restaurar MJPEG interval/quality a defaults del `.env` cargado al inicio.
...
* [x] Login OK/FAIL
* [x] Presetup fullscreen + monitor correcto
* [x] Calibración plugin/chat/scroll
* [x] Run cropped OK
* [x] Tap focus chat
* [x] Typing + Enter funciona
* [x] Drag-scroll usable
* [x] InputEnabled OFF bloquea control
* [x] Restart presetup + cambio monitor
